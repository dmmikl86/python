...
def draw(canvas):
    ...
    if (paddle1_pos - PAD_HEIGHT > 0 and paddle1_vel == -5) or (paddle1_pos < HEIGHT and paddle1_vel == 5):
        paddle1_pos += paddle1_vel

    if (paddle2_pos - PAD_HEIGHT > 0 and paddle2_vel == -5) or (paddle2_pos < HEIGHT and paddle2_vel == 5):
